...
# multiply dense hmms of hidden sizes 512 and 1024
python ../monarch_hmm/multiply_dense_hmm.py \
    ...
    --output_path \
    ${DIR}/models/monarch-hmm_text8_${HIDDEN_STATES_BLOCK_SIZE}/checkpoint-0

# train monarch hmm
CUDA_VISIBLE_DEVICES=${CUDA_CORES} torchrun --standalone --nproc_per_node=gpu \
    ../monarch_hmm/train_hmm.py \
    --init_model_path ${DIR}/models/monarch-hmm_text8_${HIDDEN_STATES_BLOCK_SIZE}/checkpoint-0 \
    --model_path ${DIR}/models/monarch-hmm_text8_${HIDDEN_STATES_BLOCK_SIZE}/ \
    --checkpoint 0 \
...
CUDA_VISIBLE_DEVICES=0 torchrun --standalone --nproc_per_node=gpu \
    ...
    --init_model_path ${DIR}/models/monarch-hmm_text8_${HIDDEN_STATES_BLOCK_SIZE}/checkpoint-1700 \
    --dataset ${DIR}/data/${DATASET}_chunk${SEQ_LEN} \
    --batch_size 125 \
    --monarch